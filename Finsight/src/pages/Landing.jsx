  ...
  return (
    <div className="font-sans text-white bg-black">
      ...
      <section className="min-h-screen flex flex-col md:flex-row items-center justify-between px-6 sm:px-10 md:px-20 py-16 md:py-20 relative overflow-hidden bg-gradient-to-r from-purple-900 via-indigo-900 to-black">
        ...
        <div className="flex-1 space-y-6 md:pr-10 relative z-10 text-center md:text-left">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-wide animate-fadeIn">
            Welcome to <span className="text-gradient bg-gradient-to-r from-green-400 via-yellow-400 to-pink-400 bg-clip-text text-transparent">STOCKFOLO</span>
          </h1>
      ...
      <section className="py-16 sm:py-20 px-6 sm:px-10 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-yellow-400 to-pink-400">Features</h2>
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
          {["Real-Time Analytics", "Insights", "Personal Watchlist"].map((feature, idx) => (
            <div key={idx} className="bg-gradient-to-r from-purple-800 via-indigo-800 to-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 animate-fadeIn">
              <h3 className="text-xl sm:text-2xl font-semibold mb-2 text-green-400">{feature}</h3>
